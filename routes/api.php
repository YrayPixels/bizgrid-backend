...
use App\Http\Controllers\AdminWhatsAppMessagesController;
use App\Http\Controllers\AdminWhatsAppSettingsController;
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::prefix('admin')->middleware('api.cache:admin')->group(function () {
            ...
            Route::post('/merchants/{id}/impersonate', [AdminMerchantController::class, 'impersonate'])
                ->middleware('admin.permission:view_as_merchant');
            ...
            Route::get('/whatsapp-messages', [AdminWhatsAppMessagesController::class, 'index']);

        ...
        $result = $this->chatJson([
            [
                ...
                'content' => implode("\n", [
                    ...
                    '- category-showcase: title, eyebrow, layout, items[{label,image_url,category_id,cta_label}]',
                    ...
                    'Registered block types: hero, stats_row, rich_text, feature_grid, cta_banner, product_grid, category_showcase, faq, contact_form.',
                    'Common block ids: hero-main, home-stats, about-spotlight, serum-promo, trust-features, category-showcase, home-faq, about-main, about-features, contact-intro, contact-form, faq-main.',

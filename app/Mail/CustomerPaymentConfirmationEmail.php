...
class CustomerPaymentConfirmationEmail extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            ...
            subject: 'Payment received for '.$this->order->order_number.' — '.$this->store->name,
        );
    }
    ...
    public function content(): Content
    {
        return new Content(
            ...
            with: [
                ...
                'orderNote' => $this->store->customer_order_note,
            ],
        );
    }

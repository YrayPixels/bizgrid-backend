...
class StoreController extends Controller
{
    ...
    public function updateStorefront(Request $request, int $storeId): JsonResponse
    {
        $data = $request->validate([
            ...
            'storefront.value_props' => 'nullable|array|max:6',
            'storefront.value_props.*.title' => 'required_with:storefront.value_props|string|max:120',
            'storefront.value_props.*.body' => 'required_with:storefront.value_props|string|max:500',
